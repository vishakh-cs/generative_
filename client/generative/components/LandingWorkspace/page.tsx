...
function LandingWorkspace() {
  return (
    ...
    >
      ...
      >
        <h1 className="text-4xl font-bold text-white mb-8">Welcome to Generative</h1>
      </motion.div>
      <div className="max-w-4xl text-center">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          >
            ...
            <h2 className="text-lg font-semibold text-white mt-4">Real-time Collaboration</h2>
            <p className="text-white text-center mt-2">Engage with your team members, collaborate on projects, and brainstorm ideas together in real-time.</p>
          </motion.div>
        ...
        >
            ...
            <a className={twMerge('bg-blue-500 hover:bg-blue-600 text-white py-3 px-8 rounded-full text-lg font-semibold transition duration-300')}>
      ...
      <motion.div 
        ...
        className="absolute bottom-5 left-0 right-0 flex justify-center items-center text-white"
      >
